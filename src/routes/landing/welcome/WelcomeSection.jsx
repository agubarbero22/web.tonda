  ...
  return (
    <section className="homepage__welcome" aria-labelledby="welcome-title">
      ...
      <LazyLoadImage
        ...
        alt="Interior del restaurante TONDA con gente en la mesa y el personal sirviendo a los clientes"
      />
    </section>
  );
};
